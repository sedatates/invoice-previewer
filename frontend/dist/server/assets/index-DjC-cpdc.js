...
function Header({ onDownload, isDownloading = false }) {
  return /* @__PURE__ */ jsx("header", { className: "bg-slate-800 border-b border-slate-700 px-6 py-4", children: /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsx("div", { className: "w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center", children: /* @__PURE__ */ jsx(
        "svg",
        {
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h1", { className: "text-xl font-bold", children: "Invoice Generator" }),
        /* @__PURE__ */ jsx("p", { className: "text-slate-400 text-xs", children: "Create professional invoices" })
      ] })
    ] }),
...
function TemplateSelector({
  ...
  if (loading) {
    return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
      /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-slate-300 mb-3", children: "Template" }),
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
    /* @__PURE__ */ jsx("label", { className: "block text-sm font-medium text-slate-300 mb-3", children: "Template" }),
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-3 gap-2", children: templates.map((template) => {
      ...
      return /* @__PURE__ */ jsxs(
        "button",
        {
          ...
          children: [
            ...
            isSelected && /* @__PURE__ */ jsx("div", { className: "absolute top-1 right-1", children: /* @__PURE__ */ jsx(
              "svg",
              {
...
function CompanyForm({ invoice, updateField }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
    /* @__PURE__ */ jsxs("h3", { className: "text-sm font-medium text-slate-300 mb-3 flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(
        "svg",
        {
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Company Name" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Logo URL (optional)" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Address" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
            rows: 2,
...
function ClientForm({ invoice, updateField }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Client Name" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Client Address" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
            rows: 2,
...
function InvoiceDetailsForm({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Invoice Number" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "text",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Currency" }),
        /* @__PURE__ */ jsx(
          "select",
          {
            ...
            className: "w-full bg-slate-700 border border-slate-600 rounded-lg px-3 py-2 text-sm text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30",
            children: CURRENCIES.map((c) => /* @__PURE__ */ jsx("option", { value: c.value, children: c.label }, c.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Issue Date" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "date",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Due Date" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "date",
...
function LineItemsForm({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-3", children: [
      /* @__PURE__ */ jsxs("h3", { className: "text-sm font-medium text-slate-300 flex items-center gap-2", children: [
        /* @__PURE__ */ jsx(
          "svg",
          {
    ...
    /* @__PURE__ */ jsx("div", { className: "space-y-2", children: items.map((item, index) => /* @__PURE__ */ jsxs("div", { className: "bg-slate-700/50 rounded-lg p-3 space-y-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-2", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "text-[10px] text-slate-400", children: "Quantity" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "number",
        ...
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("label", { className: "text-[10px] text-slate-400", children: "Rate" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              type: "number",
...
function TaxNotesForm({ invoice, updateField }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-slate-800 rounded-xl p-4 border border-slate-700", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Tax Rate (%)" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "number",
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("label", { className: "block text-xs text-slate-400 mb-1", children: "Notes" }),
        /* @__PURE__ */ jsx(
          "textarea",
          {
            rows: 3,
...
function InvoicePreview({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "preview-panel bg-slate-800 rounded-xl border border-slate-700 overflow-hidden flex flex-col shadow-2xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "bg-slate-700/50 px-4 py-3 border-b border-slate-700 flex items-center justify-between shrink-0", children: [
      /* @__PURE__ */ jsx("span", { className: "text-sm font-medium text-slate-300", children: "Preview" }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxs("span", { className: "text-lg font-bold text-green-400", children: [
        invoice.currency,
        total.toFixed(2)
      ] }) })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto p-4 bg-slate-600/30 flex justify-center", children: /* @__PURE__ */ jsx(
      "div",
      {
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    appLoading && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 bg-slate-900/80 flex items-center justify-center z-50", children: /* @__PURE__ */ jsxs("div", { className: "text-center", children: [
      /* @__PURE__ */ jsx("div", { className: "animate-spin rounded-full h-12 w-12 border-4 border-blue-500 border-t-transparent mx-auto" }),
      /* @__PURE__ */ jsx("p", { className: "text-slate-400 mt-4", children: "Loading templates..." })
    ] }) }),
    /* @__PURE__ */ jsx(Header, { onDownload: handleDownload, isDownloading }),
    /* @__PURE__ */ jsx("main", { className: "max-w-7xl mx-auto p-6", children: /* @__PURE__ */ jsxs("div", { className: "main-grid grid grid-cols-[400px_1fr] gap-6 items-start", children: [
      /* @__PURE__ */ jsxs("div", { className: "editor-panel space-y-4 pr-2", children: [
        /* @__PURE__ */ jsx(TemplateSelector, { templates, selectedTemplate, onSelect: setSelectedTemplate, loading: templatesLoading }),
        /* @__PURE__ */ jsx(CompanyForm, { invoice, updateField }),
        /* @__PURE__ */ jsx(ClientForm, { invoice, updateField }),
        /* @__PURE__ */ jsx(InvoiceDetailsForm, { invoice, updateField }),
        /* @__PURE__ */ jsx(LineItemsForm, { items: invoice.items, addItem, removeItem, updateItem }),
        /* @__PURE__ */ jsx(TaxNotesForm, { invoice, updateField })
      ] }),
      /* @__PURE__ */ jsx(InvoicePreview, { invoice, templateHtml, total })
    ] }) }),
